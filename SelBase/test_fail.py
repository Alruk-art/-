...
class FailingTests(BaseCase):
    ...
    def test_find_army_of_robots_on_xkcd_desert_island(self):
        ...
        self.assert_element("div#Desert Island", timeout=1)
        #self.assert_text("Desert Island", timeout=1 ); """valid"""
        #self.assert_element('img[alt*="Desert Island"]', timeout=1 ) #valid
